...
public interface Blockchain {
     ...
     * Bohr doesn't store coinbase transaction in blocks.
     *
     * @param blockNumber
     *            the block number
    ...
    /**
     * Returns coinbase reward transaction of the block number. This method is required as
     * Bohr doesn't store coinbase reward transaction in blocks.
     *
     * @param blockNumber the block number
     * @return the coinbase reward transaction
     */
     ...
     * @return
     */
    List<BohrInternalTransaction> getInternalTransactions(byte[] address, int from, int to);
