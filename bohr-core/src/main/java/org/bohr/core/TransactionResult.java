...
public class TransactionResult {
     ...
     */
    protected List<BohrInternalTransaction> internalTransactions;
    ...
    public List<BohrInternalTransaction> getInternalTransactions() {
        return internalTransactions;
    }

    public void setInternalTransactions(List<BohrInternalTransaction> internalTransactions) {
        this.internalTransactions = internalTransactions;
    }

    public void addInternalTransaction(BohrInternalTransaction internalTransaction) {
    ...
    public static TransactionResult fromBytes(byte[] bytes) {
        ...
        if (dec.getReadIndex() != bytes.length) {
            ...
            List<BohrInternalTransaction> internalTransactions = new ArrayList<>();
            n = dec.readInt();
            for (int i = 0; i < n; i++) {
                internalTransactions.add(BohrInternalTransaction.fromBytes(dec.readBytes()));
            }
    ...
    public byte[] toBytes() {
        ...
        for (BohrInternalTransaction tx : internalTransactions) {
