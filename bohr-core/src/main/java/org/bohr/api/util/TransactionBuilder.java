...
/**
 * This is a builder class for building transactions required by Bohr API with
    ...
    public Transaction buildUnsigned() {
        ...
        if (to == null) {
            if (type == TransactionType.DELEGATE ){
                to = Constants.DELEGATE_BURN_ADDRESS;
            }else if (type == TransactionType.CREATE) {
