...
import org.bohr.api.ApiHandler;
import org.bohr.config.Config;
import org.bohr.util.BasicAuth;
...
public class HttpHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    private static final MimetypesFileTypeMap mimeTypesMap = new MimetypesFileTypeMap(
            HttpHandler.class.getResourceAsStream("/org/bohr/api/mime.types"));
    ...
    protected void channelRead0(ChannelHandlerContext ctx, FullHttpRequest msg) {
        ...
        if ("/".equals(path)) {
            lastContentFuture = writeStaticFile(ctx, "/org/bohr/api/index.html");
            ...
            if (path.startsWith("/swagger-ui/")) {
                ...
                lastContentFuture = writeStaticFile(ctx, "/org/bohr/api" + path);
            }
            ...
            if (apiHandler.isAuthRequired(msg.method(), path) && !checkBasicAuth(headers)) {
                ...
                resp.headers().set(HttpHeaderNames.WWW_AUTHENTICATE, "Basic realm=\"Bohr RESTful API\"");
