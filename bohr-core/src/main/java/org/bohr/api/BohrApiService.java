...
import org.bohr.api.http.HttpChannelInitializer;
 ...
 * Bohr API launcher
 */
public class BohrApiService {

    private static final Logger logger = LoggerFactory.getLogger(BohrApiService.class);
    ...
    public BohrApiService(Kernel kernel) {
        this.kernel = kernel;
