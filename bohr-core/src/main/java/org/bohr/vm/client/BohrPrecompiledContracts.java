...
import static org.bohr.vm.client.Conversion.weiToAmount;
...
public class BohrPrecompiledContracts extends ConstantinoplePrecompiledContracts {
    ...
    public static class Vote implements PrecompiledContract {
        ...
        public Pair<Boolean, byte[]> execute(PrecompiledContractContext context) {
            ...
            if (track instanceof BohrRepository) {
                BohrRepository bohrTrack = (BohrRepository) track;
                AccountState as = bohrTrack.getAccountState();
                DelegateState ds = bohrTrack.getDelegateState();
