...
/**
 * Represents a client which connects to the Bohr network.
 */
public class PeerClient {
    ...
    public PeerClient(String ip, int port, Key coinbase) {
        logger.info("Peer client info: peerId = {}, ip = {}, port = {}", coinbase.toAddressBase58(), ip, port);
     ...
     * @return
     */
    public ChannelFuture connect(Node remoteNode, BohrChannelInitializer ci) {
