...
public class BohrFrameHandler extends ByteToMessageCodec<Frame> {

    private static final Logger logger = LoggerFactory.getLogger(BohrFrameHandler.class);

    private final Config config;

    public BohrFrameHandler(Config config) {
        this.config = config;
    }
