 ...
 */
package org.bohr.net;

import static org.bohr.net.msg.p2p.NodesMessage.MAX_NODES;
...
import org.bohr.core.BftManager;
import org.bohr.core.Block;
import org.bohr.core.BlockHeader;
import org.bohr.core.BlockPart;
...
import org.bohr.net.msg.MessageQueue;
import org.bohr.net.msg.ReasonCode;
import org.bohr.net.msg.consensus.BlockHeaderMessage;
import org.bohr.net.msg.consensus.BlockMessage;
import org.bohr.net.msg.consensus.BlockPartsMessage;
import org.bohr.net.msg.consensus.GetBlockHeaderMessage;
import org.bohr.net.msg.consensus.GetBlockMessage;
import org.bohr.net.msg.consensus.GetBlockPartsMessage;
import org.bohr.net.msg.consensus.NewHeightMessage;
import org.bohr.net.msg.p2p.DisconnectMessage;
import org.bohr.net.msg.p2p.GetNodesMessage;
import org.bohr.net.msg.p2p.NodesMessage;
import org.bohr.net.msg.p2p.PingMessage;
import org.bohr.net.msg.p2p.PongMessage;
import org.bohr.net.msg.p2p.TransactionMessage;
import org.bohr.net.msg.p2p.handshake.v2.HelloMessage;
import org.bohr.net.msg.p2p.handshake.v2.InitMessage;
import org.bohr.net.msg.p2p.handshake.v2.WorldMessage;
...
/**
 * Bohr P2P message handler
 */
public class BohrP2pHandler extends SimpleChannelInboundHandler<Message> {

    private final static Logger logger = LoggerFactory.getLogger(BohrP2pHandler.class);
     ...
     * @param channel
     */
    public BohrP2pHandler(Channel channel, Kernel kernel) {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        if (useNewHandShake) {
            ...
            if (channel.isOutbound()) {
                Message helloMessage = new org.bohr.net.msg.p2p.handshake.v1.HelloMessage(
    ...
    public void channelRead0(final ChannelHandlerContext ctx, Message msg) throws InterruptedException {
        ...
        case HELLO:
            if (!useNewHandShake)
                onHello((org.bohr.net.msg.p2p.handshake.v1.HelloMessage) msg);
            break;
        case WORLD:
            if (!useNewHandShake)
                onWorld((org.bohr.net.msg.p2p.handshake.v1.WorldMessage) msg);
            break;
        case PING:
            onPing();
            break;
    ...
    protected void onHello(org.bohr.net.msg.p2p.handshake.v1.HelloMessage msg) {
        ...
        msgQueue.sendMessage(new org.bohr.net.msg.p2p.handshake.v1.WorldMessage(
                config.network(), config.networkVersion(), client.getPeerId(),
                client.getIp(), client.getPort(),
                config.getClientId(),
                chain.getLatestBlockNumber(),
    ...
    protected void onWorld(org.bohr.net.msg.p2p.handshake.v1.WorldMessage msg) {
        Peer peer = msg.getPeer();
