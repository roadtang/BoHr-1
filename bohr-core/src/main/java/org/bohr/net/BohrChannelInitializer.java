...
public class BohrChannelInitializer extends ChannelInitializer<NioSocketChannel> {

    private static final Logger logger = LoggerFactory.getLogger(BohrChannelInitializer.class);
    ...
    /**
     * Create an instance of BohrChannelInitializer.
     * 
     * @param kernel
     *            the kernel instance
     * @param remoteNode
     ...
     */
    public BohrChannelInitializer(Kernel kernel, Node remoteNode, boolean discoveryMode) {
        this.kernel = kernel;
    ...
    public BohrChannelInitializer(Kernel kernel, Node remoteNode) {
