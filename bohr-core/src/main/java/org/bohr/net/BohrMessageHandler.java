...
import org.bohr.net.msg.MessageException;
import org.bohr.net.msg.MessageFactory;
...
public class BohrMessageHandler extends MessageToMessageCodec<Frame, Message> {

    private static final Logger logger = LoggerFactory.getLogger(BohrMessageHandler.class);
    ...
    public BohrMessageHandler(Config config) {
        this.config = config;
