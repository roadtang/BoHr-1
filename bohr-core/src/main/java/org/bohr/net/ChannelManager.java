...
public class ChannelManager {
    ...
    protected final BohrIpFilter ipFilter;

    public ChannelManager(Kernel kernel) {
        ipFilter = new BohrIpFilter.Loader()
                .load(new File(kernel.getConfig().configDir(), BohrIpFilter.CONFIG_FILE).toPath());
    }
     ...
     * @return
     */
    public BohrIpFilter getIpFilter() {
        return ipFilter;
    }
