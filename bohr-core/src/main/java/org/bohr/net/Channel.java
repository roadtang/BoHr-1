...
public class Channel {
    ...
    public void init(ChannelPipeline pipe, boolean isInbound, InetSocketAddress remoteAddress, Kernel kernel) {
        ...
        pipe.addLast("frameHandler", new BohrFrameHandler(kernel.getConfig()));
        pipe.addLast("messageHandler", new BohrMessageHandler(kernel.getConfig()));
        pipe.addLast("p2pHandler", new BohrP2pHandler(this, kernel));
    }
