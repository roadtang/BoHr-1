...
import org.bohr.gui.dialog.ChangePasswordDialog;
import org.bohr.gui.dialog.ConsoleDialog;
import org.bohr.gui.dialog.ExportPrivateKeyDialog;
...
public class MenuBar extends JMenuBar implements ActionListener {
    ...
    public MenuBar(BohrGui gui, JFrame frame) {
        this.gui = gui;
        this.frame = frame;
    ...
    private void apiExplorer() {
        if (Desktop.isDesktopSupported()) {
            final String swaggerUrl = gui.getKernel().getApi().getApiExplorerUrl();
            try {
