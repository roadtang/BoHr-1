...
//		if (UIConfig.isOldUI()) {
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addContainerGap().addComponent(labelLogo).addGap(18)
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING).addComponent(lblMessage)
								.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
										...
										.addGroup(groupLayout.createSequentialGroup()
												.addComponent(btnCancel, GroupLayout.PREFERRED_SIZE, 100,
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup().addGap(12).addComponent(labelLogo))
						.addGroup(groupLayout.createSequentialGroup().addGap(21).addComponent(lblMessage).addGap(18)
...
//											.addComponent(textField, GroupLayout.DEFAULT_SIZE, 313, Short.MAX_VALUE)
//											.addGroup(groupLayout.createSequentialGroup()
//													.addComponent(btnCancel, 110, 110, 110).addGap(15)
//													.addComponent(btnOk, 110, 110, 110))))
//							.addGap(17)));
//			groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
//					.createSequentialGroup()
//					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
...
//											.addComponent(btnOk, 30, 30, 30).addComponent(btnCancel, 30, 30, 30))))
//					.addContainerGap(20, Short.MAX_VALUE)));
//		}
