...
import org.bohr.util.CircularFixedSizeList;
import org.bohr.util.CommandParser;
...
public class ConsoleDialog extends JDialog implements ActionListener {
    ...
    private final transient BohrApiImpl api;
    ...
    public ConsoleDialog(BohrGui gui, JFrame parent) {
        ...
        this.api = new org.bohr.api.v2.BohrApiImpl(gui.getKernel());
        for (Method m : BohrApi.class.getMethods()) {
