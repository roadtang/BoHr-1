...
import org.bohr.gui.AddressBookEntry;
...
public class AddressBookDialog extends JDialog implements ActionListener {
    ...
    public AddressBookDialog(JFrame parent, Wallet wallet, BohrGui gui) {
        ...
        panel.setBackground(BohrGui.getColorBlack2());
    ...
    private static class AddressTableModel extends AbstractTableModel {
        ...
        public Object getValueAt(int row, int column) {
            ...
            case 1:
                return StringUtil.hexToBase58(entry.getAddress()) ;
            default:
                return null;
            }
        }
        ...
        case DELETE_ADDRESS:
            ...
            if (entry != null) {
                if (action == Action.COPY_ADDRESS) {
                    ...
                    String addressK=ModelUtils.getKEY(entry.getAddress());
                    cb.setContents(new StringSelection(addressK), null);

                    JOptionPane.showMessageDialog(this, GuiMessages.get("AddressCopied", addressK));
                } else {
