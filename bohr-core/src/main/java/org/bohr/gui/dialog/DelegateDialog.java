...
public class DelegateDialog extends JDialog {
    ...
    public DelegateDialog(BohrGui gui, JFrame parent, WalletDelegate d) {
        ...
        JTextArea address = SwingUtil.textAreaWithCopyPopup(StringUtil.hexToBase58(Hex.encode0x(d.getAddress())) );
