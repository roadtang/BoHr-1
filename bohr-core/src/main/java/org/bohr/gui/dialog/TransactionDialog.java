...
public class TransactionDialog extends JDialog implements ActionListener {
    ...
    public TransactionDialog(JFrame parent, Transaction tx, Kernel kernel) {
        ...
        JTextArea from = SwingUtil.textAreaWithCopyPopup(StringUtil.hexToBase58(Hex.encode0x(tx.getFrom())) );
        from.setName("fromText");
        from.setBackground(null);
        JTextArea to = SwingUtil.textAreaWithCopyPopup( StringUtil.hexToBase58(Hex.encode0x(tx.getTo())) );
        to.setName("toText");
