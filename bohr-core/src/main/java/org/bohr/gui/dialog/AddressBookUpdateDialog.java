...
public class AddressBookUpdateDialog extends JDialog implements ActionListener {
    ...
    public AddressBookUpdateDialog(Window parent, AddressBookEntry entry, Wallet wallet, BohrGui gui) {
        super(parent,
        ...
        addressText = new JTextField(entry != null ? ModelUtils.getKEY(entry.getAddress()) : "");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        case OK:
            ...
            //K0x
            address=ModelUtils.getOX(address);
