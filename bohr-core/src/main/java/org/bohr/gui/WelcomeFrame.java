...
public class WelcomeFrame extends JFrame implements ActionListener {
	...
	public WelcomeFrame(Wallet wallet) {
		...
		banner.setIcon(SwingUtil.loadImage("banner", 125, 125));
		...
		btnCreate.setUI(new DefaultRadioButtonUI());
		btnRecover.setUI(new DefaultRadioButtonUI());
		btnCancel.setUI(new EmptyBlueArcButtonUI(new Color(0xFFAD00)));
		...
		initui1(banner, description, panel, btnCancel, lblPassword);

	}

	private void initui1(JLabel banner, JLabel description, JPanel panel, JButton btnCancel, JLabel lblPassword) {
		// @formatter:off
				...
				.addGroup(groupLayout.createSequentialGroup()
						.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
								.addGroup(groupLayout.createSequentialGroup().addContainerGap()
										.addComponent(btnCancel, 126, 126, 126).addGap(18)
										.addComponent(btnNext, 126, 126, 126))
								.addGroup(groupLayout.createSequentialGroup().addGap(21)
										.addComponent(
												banner, GroupLayout.PREFERRED_SIZE, 140, GroupLayout.PREFERRED_SIZE)
										.addGap(18)
										.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
												.addComponent(lblPasswordRepeat)
												.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
														.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
																.addComponent(panel, GroupLayout.DEFAULT_SIZE, 490,
																		Short.MAX_VALUE)
																.addComponent(lblPassword).addComponent(description,
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false).addGroup(groupLayout
						.createSequentialGroup().addGap(10).addComponent(description).addGap(10)
						.addComponent(panel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addGap(20).addComponent(lblPassword).addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(txtPassword, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(lblPasswordRepeat)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(txtPasswordRepeat,
								GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE))
						.addGroup(groupLayout.createSequentialGroup().addGap(10).addComponent(banner,
								GroupLayout.PREFERRED_SIZE, 293, GroupLayout.PREFERRED_SIZE)))
				.addPreferredGap(ComponentPlacement.RELATED, 84, Short.MAX_VALUE)
				.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(btnNext, 48, 48, 48)
						.addComponent(btnCancel, 48, 48, 48))
				.addGap(21)));
		// @formatter:on
	...
	protected void ok() {
		...
		if (isCreate()) {
			...
			if (!w.unlock(password)) {
				...
				if (wallet.unlock(password) && wallet.addWallet(w) > 0 && wallet.flush()) {
					done();
				} else {
					JOptionPane.showMessageDialog(this, GuiMessages.get("WalletSaveFailed"));
					SystemUtil.exitAsync(SystemUtil.Code.FAILED_TO_WRITE_WALLET_FILE);
